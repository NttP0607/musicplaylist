...
const AddSongModal = ({ onClose }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        desc: "",
        artistName: "",
        albumName: "none", // Mặc định là 'none'
        genre: "",
        mood: "",
        lyrics: "",
    });
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.name || !formData.artistName || !audioFile) {
            toast.error("Vui lòng nhập Tên Bài Hát, Nghệ Sĩ và chọn File Nhạc.");
            return;
        }
        ...
        // Thêm file (audio bắt buộc, image tùy chọn)
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end pt-4">
                        <button
                            ...
                            className="px-6 py-2 bg-green-600 text-white font-semibold rounded-md hover:bg-green-700 transition duration-150 disabled:bg-gray-400"
                        >
